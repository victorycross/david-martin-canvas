  ...
  return <div className="min-h-screen bg-gradient-hero">
      ...
      <section className="container pt-20 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <HeroPanel title="Build" description="Discover applications, AI tools, and technology risk frameworks that solve real-world problems and drive informed decision-making." icon={<Code className="h-8 w-8 text-white" />} href="/technology" gradient="bg-accent" />
